...
import SlidersBtns from "../restaurants/slidersBtns/SlidersBtns";
import { filterCollection } from "../../services/fillterCollection";
import { getMenuAsync } from "../../redux/actions/restaurantsActions";
const btns = [
...
const Restaruant = () => {
    ...
    const { restaurants, loading, menu } = useSelector(
        (store) => store.restaurants
    );
    const [currentR, setCurrentR] = useState(
        restaurants.find((item) => item.id == resId)
    );
