    ...
    return (
        <div className="absolute lef-2 top-2 w-full h-full bg-white z-10">
            ...
            <motion.div
                ...
                className="absolute cursor-pointer top-2 left-2 text-white flex items-center"
                onClick={() => {
                    navigate(-1);
                }}
            >
            ...
            <section className="p-4 flex flex-col justify-between h-1/2 items-center">
                ...
                <div className="flex w-full items-center gap-5 justify-center">
                    ...
                    <button
                        ...
                        onClick={() => handleAdd()}
                        className="p-2 bg-yellow-400 rounded-md flex justify-between w-1/2"
                    >
                        Add <span>${price}</span>
                    </button>
                </div>
