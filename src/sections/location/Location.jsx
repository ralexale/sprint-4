...
const Location = () => {
    ...
    useEffect(() => {
        if (error.status) {
            ...
            Swal.fire(
                "Excelente",
                "Se ha actualizado tu locación exitosamente",
                "success"
            ).then(() => {
                navigate(-1);
            });
    ...
    return (
        ...
        >
            ...
            >
                ...
                <button
                    disabled={loading}
                    className="p-4 bg-yellow-300 rounded-md w-11/12 flex items-center justify-center font-semibold h-11"
                    type="submit"
                >
                    Update Location
                </button>
