...
import { getMenu, getMenuAsync } from "../../redux/actions/restaurantsActions";
...
const Search = () => {
    ...
    return (
        ...
        >
            ...
            {!menu.length ? (
                <>
                    {user.recentSearchs.length ? (
                        <section>
                            <h2 className="text-xl text-black-100">
                                Recent searches
                            </h2>
                            <section>
